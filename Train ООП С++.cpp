...
int main()
{
    ...
    bool isFind = false;
     ...
     for(int i = 0; i < 4; i++)
    {
        if(trains[i].getHours() >= hours && trains[i].getMinutes() >= minutes || trains[i].getHours() == hours && trains[i].getMinutes() == minutes || trains[i].getHours() <= hours && trains[i].getMinutes() <= minutes){
            cout << endl;
            cout << "Number: " << trains[i].getNumber() << endl;
            cout << "Destination: " << trains[i].getDestination() << endl;
            cout << "Hours: " << trains[i].getHours() << endl;
